...
<!-- Mirrored from themesflat.co/html/ecomus/shop-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Feb 2025 04:03:25 GMT -->
                        ...
                        <div class="widget-facet wd-categories">
                            ...
                            <div id="categories" class="collapse show">
                                <ul class="list-categoris current-scrollbar mb_36">
                                    ...
                                    <li class="cate-item"><a href="#"><span>Men</span>&nbsp;<span>(9)</span></a>
                                    </li>
                                    <li class="cate-item"><a
                                            href="#"><span>Women</span>&nbsp;<span>(23)</span></a></li>
                                    <li class="cate-item"><a
                                            href="#"><span>Denim</span>&nbsp;<span>(20)</span></a></li>
                                    <li class="cate-item"><a
                                            href="#"><span>Dress</span>&nbsp;<span>(23)</span></a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div id="sale-products" class="collapse show">
                                <div class="widget-featured-products mb_36">
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('front_assets') }}/images/products/img-feature-1.png"
                                                alt="image-feature">
                                        </a>
                                    ...
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('front_assets') }}/images/products/img-feature-2.png"
                                                alt="image-feature">
                                        </a>
                                        <div class="card-product-info">
                                    ...
                                    <div class="featured-product-item">
                                        <a href="product-detail.html" class="card-product-wrapper">
                                            <img class="lazyload img-product"
                                                data-src="{{ asset('front_assets') }}/images/products/img-feature-3.png"
                                                alt="image-feature">
                                        </a>
                                        <div class="card-product-info">
                            ...
                            <div id="gallery" class="collapse show">
                                <div class="grid-3 gap-4 mb_36">
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload"
                                            data-src="{{ asset('front_assets') }}/images/shop/gallery/gallery-1.jpg"
                                            alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload"
                                            data-src="{{ asset('front_assets') }}/images/shop/gallery/gallery-2.jpg"
                                            alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload"
                                    ...
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload"
                                            data-src="{{ asset('front_assets') }}/images/shop/gallery/gallery-4.jpg"
                                            alt="img-gallery">
                                    </a>
                                    <a href="product-detail.html" class="item-gallery">
                                        <img class="lazyload"
                        ...
                        <div class="tf-list-layout wrapper-shop" id="listLayout">
                            ...
                            <div class="card-product list-layout" data-availability="In stock" data-brand="Ecomus">
                                ...
                                <div class="card-product-info">
                                    ...
                                    <div class="list-product-btn">
                                        <a href="#quick_add" data-bs-toggle="modal"
                                            class="box-icon quick-add style-3"><span
                                                class="icon icon-bag"></span><span class="tooltip">Quick
                                                add</span></a>
                                        <a href="#" class="box-icon wishlist style-3"><span
                                                class="icon icon-heart"></span> <span class="tooltip">Add to
                                                Wishlist</span></a>
                                        <a href="#compare" data-bs-toggle="offcanvas"
                                            class="box-icon compare style-3"><span class="icon icon-compare"></span>
                                            <span class="tooltip">Add to Compare</span></a>
                                        <a href="#quick_view" data-bs-toggle="modal"
                                            class="box-icon quickview style-3"><span
                                                class="icon icon-view"></span><span class="tooltip">Quick
                                                view</span></a>
                                    </div>
                                </div>
                    ...
                    <div class="row-demo">
                        <div class="demo-item">
                            <a href="index.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-01.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-01.jpg" alt="home-01">
                        ...
                        <div class="demo-item">
                            <a href="home-multi-brand.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-multi-brand.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-multi-brand.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-02.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-02.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-02.jpg" alt="home-02">
                                    <div class="demo-label">
                                        <span class="demo-hot">Hot</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-03.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-03.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-03.jpg" alt="home-03">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-04.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-04.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-04.jpg" alt="home-04">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-05.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-05.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-05.jpg" alt="home-05">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-06.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-06.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-06.jpg" alt="home-06">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-personalized-pod.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-personalized-pod.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-personalized-pod.jpg"
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-pickleball.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-pickleball.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-pickleball.png"
                                        alt="home-pickleball">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-ceramic.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-ceramic.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-ceramic.png"
                                        alt="home-ceramic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-food.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-food.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-food.png" alt="home-food">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item position-relative">
                            <a href="home-camp-and-hike.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-camp-and-hike.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-camp-and-hike.png"
                        ...
                        <div class="demo-item">
                            <a href="home-07.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-07.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-07.jpg" alt="home-07">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-08.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-08.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-08.jpg" alt="home-08">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-headphone.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-headphone.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-headphone.jpg"
                                        alt="home-headphone">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-giftcard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-giftcard.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-giftcard.jpg"
                                        alt="home-gift-card">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-furniture-02.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-furniture2.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-furniture2.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-skateboard.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-skateboard.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-skateboard.jpg"
                                        alt="home-skateboard">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-stroller.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-stroller.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-stroller.jpg"
                                        alt="home-stroller">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-setup-gear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-setup-gear.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-setup-gear.jpg"
                                        alt="home-setup-gear">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-dog-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-dog-accessories.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-dog-accessories.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-kitchen-wear.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-kitchen.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-kitchen.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-phonecase.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-phonecase.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-phonecase.jpg"
                                        alt="home-phonecase">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-paddle-boards.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home_paddle_board.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home_paddle_board.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-glasses.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-glasses.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-glasses.jpg"
                                        alt="home-glasses">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-pod-store.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-pod-store.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-pod-store.jpg"
                                        alt="home-pod-store">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-handbag.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-handbag.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-handbag.jpg"
                                        alt="home-handbag">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-tee.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-tee.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-tee.jpg" alt="home-tee">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-socks.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-socks.jpg"
                                        alt="home-sock">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sneaker.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-sneaker.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-sneaker.jpg"
                                        alt="home-sneaker">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-accessories.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-accessories.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-accessories.jpg"
                        ...
                        <div class="demo-item">
                            <a href="home-grocery.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-gocery.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-gocery.jpg"
                                        alt="home-grocery">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html">
                                <div class="demo-image">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-baby.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-baby.jpg"
                                        alt="home-baby">
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-cosmetic.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-cosmetic.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-cosmetic.png"
                                        alt="home-cosmetic">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-plant.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-plant.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-plant.png"
                                        alt="home-plant">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-swimwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-swimwear.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-swimwear.png"
                                        alt="home-swimwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electric-bike.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-electric-bike.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-electric-bike.png"
                        ...
                        <div class="demo-item">
                            <a href="home-footwear.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-footwear.jpg"
                                        src="{{ asset('front_assets') }}/images/demo/home-footwear.jpg"
                                        alt="home-footwear">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-book-store.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-bookstore.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-bookstore.png"
                                        alt="home-bookstore">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                        ...
                        <div class="demo-item">
                            <a href="home-gaming-accessories.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload"
                                        data-src="{{ asset('front_assets') }}/images/demo/home-gaming-accessories.png"
                                        src="{{ asset('front_assets') }}/images/demo/home-gaming-accessories.png"
                    ...
                    <li class="nav-mb-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse">
                            <ul class="sub-nav-menu">
                                ...
                                <li><a href="home-camp-and-hike.html" class="sub-nav-link">Home Camp And Hike</a>
                                </li>
                                ...
                                <li><a href="home-electric-bike.html" class="sub-nav-link">Home Electric Bike</a>
                                </li>
                ...
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option data-thumbnail="{{ asset('front_assets') }}/images/country/fr.svg">EUR <span>€ |
                                    France</span></option>
                            <option data-thumbnail="{{ asset('front_assets') }}/images/country/de.svg">EUR <span>€ |
                                    Germany</span></option>
                            <option selected data-thumbnail="{{ asset('front_assets') }}/images/country/us.svg">USD
                                <span>$ | United States</span></option>
                            <option data-thumbnail="{{ asset('front_assets') }}/images/country/vn.svg">VND <span>₫ |
                                    Vietnam</span></option>
                        </select>
                    </div>
                    ...
                    <div class="widget-facet">
                        ...
                        <div id="color" class="collapse show">
                            <ul class="tf-filter-group filter-color current-scrollbar mb_36">
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_beige"
                                        id="Beige" value="Beige">
                                    <label for="Beige"
                                        class="label"><span>Beige</span>&nbsp;<span>(3)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_dark"
                                        id="Black" value="Black">
                                    <label for="Black"
                                        class="label"><span>Black</span>&nbsp;<span>(18)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_blue-2"
                                        id="Blue" value="Blue">
                                    <label for="Blue"
                                        class="label"><span>Blue</span>&nbsp;<span>(3)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_brown"
                                        id="Brown" value="Brown">
                                    <label for="Brown"
                                        class="label"><span>Brown</span>&nbsp;<span>(3)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_cream"
                                ...
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_grey"
                                        id="Grey" value="Grey">
                                    <label for="Grey"
                                ...
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_orange"
                                        id="Orange" value="Orange">
                                    <label for="Orange"
                                        class="label"><span>Orange</span>&nbsp;<span>(1)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_pink"
                                        id="Pink" value="Pink">
                                    <label for="Pink"
                                        class="label"><span>Pink</span>&nbsp;<span>(2)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_taupe"
                                        id="Taupe" value="Taupe">
                                    <label for="Taupe"
                                        class="label"><span>Taupe</span>&nbsp;<span>(1)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_white"
                                        id="White" value="White">
                                    <label for="White"
                                        class="label"><span>White</span>&nbsp;<span>(14)</span></label>
                                </li>
                                <li class="list-item d-flex gap-12 align-items-center">
                                    <input type="radio" name="color" class="tf-check-color bg_yellow"
                            ...
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="#cate-shop-one"
                                        ...
                                        <div class="image">
                                            <img src="{{ asset('front_assets') }}/images/shop/cate/cate6.jpg"
                                                alt="">
                                        </div>
                                        <span>Mens</span>
                                        <span class="btn-open-sub"></span>
                                ...
                                <li>
                                    <a href="#cate-shop-two"
                                        ...
                                        <div class="image">
                                            <img src="{{ asset('front_assets') }}/images/shop/cate/cate9.jpg"
                                                alt="">
                                        </div>
                                        <span>Womens</span>
                                        <span class="btn-open-sub"></span>
                        ...
                        <form class="">
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Buy with <img
                                        src="{{ asset('front_assets') }}/images/payments/paypal.png"
                                        alt=""></a>
                    ...
                    <div class="tf-product-media-wrap">
                        <div dir="ltr" class="swiper tf-single-slide">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="{{ asset('front_assets') }}/images/products/orange-1.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="{{ asset('front_assets') }}/images/products/pink-1.jpg"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload"
                                data-src="{{ asset('front_assets') }}/images/shop/products/size_chart2.jpg"
                                src="{{ asset('front_assets') }}/images/shop/products/size_chart2.jpg"
                                alt="">
                        </div>
                    </div>
                </div>
