                    ...
                    <form>
                        <table class="tf-table-page-cart">
                            ...
                            <tbody class="append">
                                ...
                                {{-- cart will be added here start --}}


                                {{-- cart will be added here end --}}
                    ...
                    <div class="tf-cart-footer-inner">
                        ...
                        <div class="tf-page-cart-checkout">
                            ...
                            <div class="tf-cart-totals-discounts">
                                <h3>Subtotal</h3>
                                <span class="total-value total">$18.00 USD</span>
                            </div>
                            <p class="tf-cart-tax">
...
@section('script')
    ...
    <script>
        $(function() {
            const cartitems = new Cart('ecommerce');
            printCart()
                              ...
                              <tr class="tf-cart-item file-delete">
                                    <td class="tf-cart-item_product">
                                        <a href="product-detail.html" class="img-box">
                                            <img src="{{ asset('front_assets') }}/images/products/${elements.image}"
                                                alt="img-product">
                                        </a>
                                        <div class="cart-info">
                                            <a href="product-detail.html" class="cart-title link"> ${elements.name}</a>
                                            <div class="cart-meta-variant">${elements.color} / M</div>
                                            <span data-id="${elements.item_id}" class="remove-cart link remove remove_item">Remove</span>
                                        </div>
                                    </td>
                                    <td class="tf-cart-item_price tf-variant-item-price" cart-data-title="Price">
                                        <div class="cart-price price">$ ${elements.price}</div>
                                    </td>
                                    <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                        <div class="cart-quantity">
                                            <div class="wg-quantity">
                                                <span data-id="${elements.item_id}" class="btn-quantity btndecrease minus-btn">
                                                ...
                                                <input type="text" name="number" value="${elements.qty}">
                                                <span data-id="${elements.item_id}" class="btn-quantity btnincrease plus-btn">
                                    ...
                                    <td class="tf-cart-item_total tf-variant-item-total" cart-data-title="Total">
                                        <div class="cart-total price">${elements.subtotal}</div>
                                    </td>
                                </tr>
