                ...
                <div class="tf-page-cart-footer">
                    <div class="tf-cart-footer-inner">
                        ...
                        <form class="tf-page-cart-checkout widget-wrap-checkout">
                            <ul class="wrap-checkout-product append">

                                {{-- cart item will be append here --}}

                                {{-- <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('front_assets') }}/images/products/kid-12.jpg" alt="product">
                                ...
                                <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('front_assets') }}/images/products/beige-2.jpg" alt="product">
                                        <span class="quantity">1</span>
                                    </figure>
                                    <div class="content">
                                        <div class="info">
                            ...
                            <div class="coupon-box">
                                <input type="text" class="coupon" placeholder="Discount code">
                                <a href="#"
                                    class="tf-btn btn-sm radius-3 btn-fill btn-icon animate-hover-btn">Apply</a>
                            </div>
                            <div class="d-flex justify-content-between line pb_20">
                                <h6 class="fw-5">Total</h6>
                                <h6 class="totalPrice total fw-5">$122.00</h6>
                            </div>
                        ...
                        <button
                            class=" place_order tf-btn radius-3 btn-fill btn-icon animate-hover-btn justify-content-center">Place
                            order</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            $(".place_order").on('click', function() {
                ...
                let payment_method = $('input[name="payment"]:checked').attr("id");
            ...
            function printCart() {
                ...
                if (items) {
                    ...
                    items.forEach(elements => {
                        ...
                        <li class="checkout-product-item">
                                    <figure class="img-product">
                                        <img src="{{ asset('front_assets') }}/images/products/${elements.image}" alt="product">
                                        <span class="quantity">${elements.qty}</span>
                                    </figure>
                                    <div class="content">
                                        <div class="info">
                                            <p class="name"> ${elements.name}</p>
                                            <span class="variant"> ${elements.color}/ ${elements.size}</span>
                                        </div>
                                        <span class="price">$ ${elements.price}</span>
                                    </div>
                                </li>
