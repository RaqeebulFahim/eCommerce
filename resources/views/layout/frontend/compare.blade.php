                                ...
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.html">
                                            <img class="radius-3" src="{{asset('front_assets')}}/images/products/orange-1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.html">
                                            <img class="radius-3" src="{{asset('front_assets')}}/images/products/pink-1.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tf-product-media-wrap">
                        <div dir="ltr" class="swiper tf-single-slide">
                            <div class="swiper-wrapper" >
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="{{asset('front_assets')}}/images/products/pink-1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src="{{asset('front_assets')}}/images/shop/products/size_chart2.jpg" src="{{asset('front_assets')}}/images/shop/products/size_chart2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
