                ...
                <div dir="ltr" class="swiper tf-sw-top_bar" data-preview="1" data-space="0"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <p class="top-bar-text fw-5">Spring Fashion Sale <a href="{{url('/ecom-shop')}}"
            ...
            <div class="col-xl-6 tf-md-hidden">
                <nav class="box-navigation text-center">
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                            ...
                                            <a href="index.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-01.jpg"
                                                        alt="home-01">
                                            ...
                                            <a href="home-02.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-02.jpg"
                                                        alt="home-02">
                                                    <div class="demo-label">
                                                        <span class="demo-hot">Hot</span>
                                                    </div>
                                            ...
                                            <a href="home-03.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-03.jpg"
                                                        alt="home-03">
                                                </div>
                                            ...
                                            <a href="home-04.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-04.jpg"
                                                        alt="home-04">
                                                </div>
                                            ...
                                            <a href="home-05.html">
                                                <div class="demo-image">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-05.jpg"
                                                        alt="home-05">
                                                </div>
                                            ...
                                            <a href="home-06.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload"
                                                        ...
                                                        src="{{ asset('front_assets') }}/images/demo/home-06.jpg"
                                                        alt="home-06">
                                                    <div class="demo-label">
                                                        <span class="demo-new">New</span>
                                                    </div>
                                    ...
                                    <div class="text-center view-all-demo">
                                        <a href="#modalDemo" data-bs-toggle="modal"
                                            class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View
                                                all demos (46+)</span><i class="icon icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div> --}}
                        </li>
                        <li class="menu-item">
                            <a href="{{url('/ecom-shop')}}" class="item-link">Shop</a>
                            {{-- <i class="icon icon-arrow-down"></i> --}}
                            {{-- <div class="sub-menu mega-menu">
                                <div class="container">
                                    <div class="row">
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-men.html"
                                                        ...
                                                        <img class="lazyload"
                                                            data-src="{{ asset('front_assets') }}/images/collections/collection-1.jpg"
                                                            src="{{ asset('front_assets') }}/images/collections/collection-1.jpg"
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-women.html"
                                                        class="collection-image img-style">
                                                        <img class="lazyload"
                                                            data-src="{{ asset('front_assets') }}/images/collections/collection-2.jpg"
                                                            src="{{ asset('front_assets') }}/images/collections/collection-2.jpg"
                                                            alt="collection-demo-1">
                                                    </a>
                                                    <div class="collection-content">
                                                        <a href="shop-women.html"
                        ...
                        <li class="menu-item">
                            <a href="{{url('/ecom-shop')}}" class="item-link">Products</a>
                            {{-- <i
                        ...
                        <li class="menu-item position-relative">
                            ...
                            <div class="sub-menu submenu-default">
                                <ul class="menu-list">
                                    ...
                                    <li class="menu-item-2">
                                        <a href="#" class="menu-link-text link text_black-2">My
                                            account</a>
                                        <div class="sub-menu submenu-default">
                                            <ul class="menu-list">
