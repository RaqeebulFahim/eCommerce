                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            <div class="footer-logo">
                                <a href="index.html">
                                    <img src="{{ asset('front_assets') }}/images/logo/logo.svg"
                                        alt="">
                                </a>
                            </div>
                            <ul>
                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-newsletter footer-col-block">
                            ...
                            <div class="tf-collapse-content">
                                <div class="footer-menu_item">Sign up to get first dibs on new arrivals,
                                    sales, exclusive content, events and more!</div>
                                <form class="form-newsletter subscribe-form" id="" action="#"
                                    method="post" accept-charset="utf-8" data-mailchimp="true">
                                    <div class="subscribe-content">
                                        <fieldset class="email">
                                            <input type="email" name="email-form"
                                                class="subscribe-email" placeholder="Enter your email...."
                                ...
                                <div class="tf-cur">
                                    <div class="tf-currencies">
                                        <select class="image-select center style-default type-currencies">
                                            <option
                                                data-thumbnail="{{ asset('front_assets') }}/images/country/fr.svg">
                                                EUR <span>€ | France</span></option>
                                            <option
                                                data-thumbnail="{{ asset('front_assets') }}/images/country/de.svg">
                                                EUR <span>€ | Germany</span></option>
                                            <option selected
                                                data-thumbnail="{{ asset('front_assets') }}/images/country/us.svg">
                                                USD <span>$ | United States</span></option>
                                            <option
                                                data-thumbnail="{{ asset('front_assets') }}/images/country/vn.svg">
                ...
                <div class="row">
                    <div class="col-12">
                        <div
                            ...
                            <div class="footer-menu_item">© <script type="text/javascript">var year = new Date();document.write(year.getFullYear());</script> Raqeebul Ecommerce. All Rights Reserved</div>
                            <div class="tf-payment">
                                <img src="{{ asset('front_assets') }}/images/payments/visa.png"
                                    alt="">
                                <img src="{{ asset('front_assets') }}/images/payments/img-1.png"
                                    alt="">
                                <img src="{{ asset('front_assets') }}/images/payments/img-2.png"
                                    alt="">
                                <img src="{{ asset('front_assets') }}/images/payments/img-3.png"
                                    alt="">
                                <img src="{{ asset('front_assets') }}/images/payments/img-4.png"
                                    alt="">
                            </div>
                        </div>
                    </div>
